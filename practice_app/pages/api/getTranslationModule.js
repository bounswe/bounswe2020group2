exports.checkTranslationResponse = function (response, sourceLanguage, targetLanguage, originalText) {
    ...
    if (isAlternativeSourceExist) {
        let i
        for (i = 0; i < response.data[8][0].length; i++) {
            alternativeSourceLangs.push(getSourceLangName(response.data[8][0][i]))
        }
    }
...
var getSourceLangName = (exports.getSourceLangName = function (sl) {
    ...
    switch (sl) {
        ...
        default: {
            const keys = Object.keys(isoLangs)
