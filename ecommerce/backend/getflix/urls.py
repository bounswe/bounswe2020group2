...
urlpatterns = [
    ...
    path('customer/<int:customer_id>/shoppingcart/<int:item_id>', views.shopping_cart.manage_single_shopping_cart_item),
    path('customer/<int:customer_id>/shoppingcart', views.shopping_cart.manage_multiple_shopping_cart_items),
    ...
    path('customer/<int:customer_id>/cards/<int:card_id>', views.card.manage_single_card),
    path('customer/<int:customer_id>/cards', views.card.manage_multiple_cards),
