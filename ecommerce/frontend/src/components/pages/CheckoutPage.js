...
export const CheckoutPage = () => {
    ...
    const onCheckout = async () => {
        setIsCheckoutLoading(true)
            try {
                const { data: {status} } = await api.post(`/checkout/payment`, {
    ...
    return ( 
        <Spin spinning={isCheckoutLoading}>
                ...
                <Spin spinning={isPriceSummaryLoading}>
                    <div className="price-summary-container">
                        ...
                        <div className="price-summary-button">
                            <Button type="primary" onClick={onCheckout} size="large" disabled={!(selectedCard&&selectedAddress&&userAgreed)}>Checkout</Button>
                        </div>
                    </div>
                </Spin>
            </div>
            ...
            <Result
                ...
                extra={<Button type="primary"><Link to="/">Go back to shopping!</Link></Button>}
            />}
